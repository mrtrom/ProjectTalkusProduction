  ...
  io.sockets.on('connection', function (socket) {
    ...
    socket.on('nextVideo', function(data){
      ...
      if (partner) {
        ...
        socket.emit('updatechat', 'SERVER', '<span class="muted">you have connected to this room</span>', 'connect', 'video', null, null, 'me');

        //Update partner window with connected message
        partnerSocket.emit('updatechat', 'SERVER', '<span class="muted">'+ "Anonym" + ' has connected to this room</span>', 'connect', 'video', null, null, 'Anonym');
    ...
    socket.on('nextText', function(data){
      ...
      if (partner) {
        ...
        //Update my window with connected message
        socket.emit('updatechat', 'SERVER', '<span class="muted">you have connected to this room</span>', 'connect', 'text');

        //Update partner window with connected message
        partnerSocket.emit('updatechat', 'SERVER', '<span class="muted">'+ "Anonym" + ' has connected to this room</span>', 'connect', 'text');
